...
const FAQS = [
  { q: "How do I calculate my exact age?", a: "Enter your date of birth in the Date of Birth field. The calculator instantly shows your exact age in years, months, and days, along with your total age in days, weeks, hours, and minutes. The calculation accounts for leap years and varying month lengths automatically." },
  { q: "What is the best free age calculator?", a: "ToolStack's age calculator is completely free, unlimited, and runs entirely in your browser. No signup required, no data storage, and you get instant results down to days, weeks, hours, and minutes." },
  { q: "How many days until my next birthday?", a: "Enter your date of birth and the calculator automatically calculates how many days remain until your next birthday, including the exact date and day of the week. The count updates each day you use it." },
  { q: "Can I calculate my age on a past or future date?", a: "Yes. The Calculate As Of field defaults to today but you can change it to any past or future date. This lets you calculate how old you were on a specific date in history, or how old you will be on a future date like a retirement date or anniversary." },
  { q: "What generation am I?", a: "The generation is determined by your birth year: Greatest Generation (before 1928), Silent Generation (1928\u20131945), Baby Boomer (1946\u20131964), Generation X (1965\u20131980), Millennial (1981\u20131996), Generation Z (1997\u20132012), Generation Alpha (2013\u2013present)." },
  { q: "How is my zodiac sign calculated?", a: "Your zodiac sign is determined by your birth month and day, based on the Western tropical zodiac system. For example, born March 21 to April 19 is Aries, April 20 to May 20 is Taurus, and so on. The exact cutoff dates used follow the standard Western astrological calendar." },
  { q: "Is my date of birth stored or sent anywhere?", a: "No. The Age Calculator runs entirely in your browser. Your date of birth is never sent to any server, stored in a database, or shared with any third party. All calculations happen locally on your device." }
];
