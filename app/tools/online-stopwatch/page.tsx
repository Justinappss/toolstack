  ...
  return (
    <div style={{ background: "#04070c", minHeight: "100vh" }}>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify([
        ...
        { "@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{ "@type": "ListItem", "position": 1, "name": "ToolStack", "item": "https://toolstack.tech" }, { "@type": "ListItem", "position": 2, "name": "Tools", "item": "https://toolstack.tech/tools" }, { "@type": "ListItem", "position": 3, "name": "Online Stopwatch", "item": "https://toolstack.tech/tools/online-stopwatch" }] },
        { "@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{ "@type": "Question", "name": "How accurate is this online stopwatch?", "acceptedAnswer": { "@type": "Answer", "text": "Accurate to the centisecond using the browser Performance API." } }, { "@type": "Question", "name": "What are the keyboard shortcuts?", "acceptedAnswer": { "@type": "Answer", "text": "Space starts/pauses. R resets. L records a lap. M switches modes." } }] },
      ]) }} />
    </div>
  );
}
