                ...
                <section style={{ marginBottom: 56 }}>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                        {[
                            ...
                            { q: "How do I fix a 'Signature verification failed' error?", a: "This error occurs on your server when the signature doesn't match the payload/header or the wrong key was used to verify it. Ensure that you are using the exact same secret (or public/private key pair) that was used to sign the token, and that the payload wasn't modified after signing." },
                        ].map(({ q, a }) => (
