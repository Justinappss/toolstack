...
const TOC = [
    ["#what-is", "What Is RankSpot?"],
    ["#how-it-works", "How It Works"],
    ["#features", "5 Core Features"],
    ["#results", "Real User Results"],
    ["#vs-alternatives", "vs Surfer & Jasper"],
                    ...
                    {TOC.map(([href, label], i) => (
                        <li key={href}>
                            <a
                                ...
                                onMouseEnter={e => { const el = e.currentTarget as HTMLElement; el.style.color = accent; el.style.background = "rgba(249,115,22,0.08)"; }}
                            ...
                            >
                                <span style={{ fontSize: 10, color: "rgba(249,115,22,0.5)", fontWeight: 700, minWidth: 14 }}>{i + 1}</span>
                                {label}
                            </a>
                        </li>
                    ))}
