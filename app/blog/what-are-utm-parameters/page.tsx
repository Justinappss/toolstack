            ...
            <div style={{ maxWidth: 720, margin: "0 auto", padding: "48px 24px 120px" }}>
                ...
                <AdBlock type="horizontal" />
                    ...
                    <div style={{ margin: "32px 0", borderRadius: 14, overflow: "hidden", border: "1px solid rgba(255,255,255,0.07)" }}>
                        <img src="/blog/what-are-utm-parameters/screenshot-tool.png" alt="ToolStack UTM builder — generate GA4-ready tracking URLs for every campaign channel" style={{ width: "100%", display: "block" }} loading="lazy" />
