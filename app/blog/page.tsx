...
const posts = [
    ...
    {
        slug: "genspark-for-word-review",
        title: "Genspark for Word Review 2026: Can This AI Add-in Beat Microsoft Copilot?",
        description: "Free AI inside Microsoft Word — live web research with cited sources, multi-model drafting (GPT-5.1, Claude Opus 4.5), and image generation. Tested for two weeks vs Copilot. 8.6/10.",
        date: "May 16, 2026",
        readTime: "10 min read",
        tag: "AI Tools",
        accent: "#7c3aed",
    ...
    {
        slug: "rankspot-review",
        title: "RankSpot Review (2026): The AI SEO Blog Agent That Finds Gaps and Fills Them",
        description: "RankSpot launched May 2026 as an AI SEO blog agent that finds keyword content gaps and generates optimised posts automatically in one workflow. Full review — features, pricing, pros/cons, and who it's actually for.",
        date: "May 16, 2026",
        readTime: "10 min read",
        tag: "SEO Tools",
        accent: "#f97316",
