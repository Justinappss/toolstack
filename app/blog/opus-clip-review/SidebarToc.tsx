...
const TOC: [string, string][] = [
    ["#what-is", "What Is Opus Clip?"],
    ["#how-it-works", "How It Works"],
    ["#features", "Core Features"],
    ["#performance", "Performance Test"],
    ["#pricing", "Pricing Plans"],
    ["#vs-alternatives", "vs Descript & Pictory"],
    ["#pros-cons", "Pros & Cons"],
    ["#who-for", "Who It's For"],
    ["#action-plan", "7-Day Start Plan"],
    ["#verdict", "Verdict"],
    ["#faq", "FAQ"],
];
                ...
                <ol style={{ margin: 0, paddingLeft: 0, listStyle: "none", display: "flex", flexDirection: "column", gap: 2 }}>
                    {TOC.map(([href, label], i) => (
                        <li key={href}>
                            ...
                            >
                                <span style={{ fontSize: 10, color: "rgba(139,92,246,0.5)", fontWeight: 700, minWidth: 14 }}>{i + 1}</span>
                                {label}
                            </a>
                        </li>
                    ))}
