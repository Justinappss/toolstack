            ...
            <div style={{ position: "relative", overflow: "hidden", paddingTop: 140, paddingBottom: 64, borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
                ...
                <div style={{ maxWidth: 720, margin: "0 auto", padding: "0 24px", position: "relative" }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 20 }}>
                        ...
                        <span style={{ fontSize: 13, color: "rgba(255,255,255,0.3)" }}>April 20, 2026 · 5 min read</span>
                    </div>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                        ...
                        <div>
                            ...
                            <p style={{ fontSize: 12, color: "rgba(255,255,255,0.35)", margin: 0 }}>Founder, ToolStack · April 20, 2026</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div style={{ maxWidth: 720, margin: "0 auto", padding: "48px 24px 120px" }}>
                ...
                <AdBlock type="horizontal" />
                    ...
                    <div style={{ margin: "32px 0", borderRadius: 14, overflow: "hidden", border: "1px solid rgba(255,255,255,0.07)" }}>
                        <img src="/blog/is-it-down-or-just-me/screenshot-tool.png" alt="ToolStack website down checker — instantly test if a site is offline or just you" style={{ width: "100%", display: "block" }} loading="lazy" />
