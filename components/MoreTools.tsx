...
export const ALL_TOOLS = [
  ...
  },
  {
    ...
    desc: "Look up domain registration date, expiry, registrar and nameservers for any domain. See who owns a domain instantly.",
    icon: "🔎",
    color: "#f97316",
  ...
  },
  {
    ...
    desc: "See how your money grows with compounding. Add monthly contributions and get a year-by-year breakdown of your investment.",
    icon: "📈",
    color: "#fbbf24",
    bg: "rgba(251,191,36,0.1)",
    border: "rgba(251,191,36,0.25)",
  ...
  },
  {
    ...
    desc: "PSA vs BGS vs SGC vs CGC — compare fees, turnaround times and resale value side-by-side. Personalised recommendation included.",
    icon: "⚖️",
    color: "#f59e0b",
    bg: "rgba(245,158,11,0.1)",
    border: "rgba(245,158,11,0.25)",
  ...
  {
    slug: "panini-sticker-calculator",
    name: "Panini Sticker Calculator",
    desc: "How many packs to complete any Panini album? World Cup 2026, Premier League, Champions League. See swap savings in GBP, USD and EUR.",
    icon: "📒",
    color: "#ef4444",
    bg: "rgba(239,68,68,0.1)",
    border: "rgba(239,68,68,0.25)",
  ...
  },
  {
    ...
    desc: "Calculate expected value for any box break. Pokémon, sports cards, football cards. EV per pack, net profit after eBay/Whatnot fees, bear/base/bull scenarios.",
    icon: "🎁",
    color: "#c084fc",
  ...
  {
    slug: "gta-6-launch-time",
    name: "GTA 6 Launch Time",
    desc: "Live countdown to 19 Nov 2026 in your own timezone, plus which countries unlock it first.",
    icon: "◷",
    color: "#22d3ee",
    bg: "rgba(34,211,238,0.1)",
    border: "rgba(34,211,238,0.25)",
  ...
  {
    slug: "gta-6-edition-comparison",
    name: "GTA 6 Edition Comparison",
    desc: "Standard vs Ultimate side by side — what the extra $20 actually buys.",
    icon: "⊞",
    color: "#a78bfa",
    bg: "rgba(167,139,250,0.1)",
    border: "rgba(167,139,250,0.25)",
  ...
  },
  {
    ...
    name: "World Cup 2026 Team Finder",
  ...
  },
  {
    ...
    desc: "Extract any YouTube video transcript instantly as clean Markdown. Toggle timestamps. Download as .md. No login, no limits.",
    icon: "🎬",
    color: "#f87171",
